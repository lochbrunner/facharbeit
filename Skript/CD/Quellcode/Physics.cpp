...
D3DXVECTOR3 CPhysics::ForceElectrical(D3DXVECTOR3 DrivenPosition, D3DXVECTOR3 DriverPosition){
	D3DXVECTOR3 v;
	float DistanceInSquare = (DrivenPosition.x - DriverPosition.x) * (DrivenPosition.x - DriverPosition.x) + 
	...
	v = (DrivenPosition - DriverPosition) / DistanceInSquare / sqrt(DistanceInSquare);
...
D3DXVECTOR3 CPhysics::ForceMagnetical(D3DXVECTOR3 DrivenSpeed, D3DXVECTOR3 DriverForce){
	...
	//v.x = DrivenSpeed.y * DriverForce.z + DrivenSpeed.z * DriverForce.y;
	//v.y = DrivenSpeed.x * DriverForce.z + DrivenSpeed.z * DriverForce.x;
	//v.z = DrivenSpeed.x * DriverForce.y + DrivenSpeed.y * DriverForce.x;

	//v.x = DriverForce.y * DrivenSpeed.z;
	//v.y = 0.0f;
	//v.z = -DriverForce.y * DrivenSpeed.x;
	
	D3DXVECTOR3 temp = D3DXVECTOR3(0.0f, 0.0f, 0.0f);

	v.x += +DrivenSpeed.z * DriverForce.y + DrivenSpeed.x * DriverForce.y * DriverForce.y * MAGNETICAL_HOLD;
	v.z += -DrivenSpeed.x * DriverForce.y + DrivenSpeed.z * DriverForce.y * DriverForce.y * MAGNETICAL_HOLD;

	v.y += -DrivenSpeed.z * DriverForce.x + DrivenSpeed.y * DriverForce.x * DriverForce.x * MAGNETICAL_HOLD;
	v.z += +DrivenSpeed.y * DriverForce.x + DrivenSpeed.z * DriverForce.x * DriverForce.x * MAGNETICAL_HOLD;

	v.x = -DrivenSpeed.y * DriverForce.z + DrivenSpeed.x * DriverForce.z * DriverForce.z * MAGNETICAL_HOLD;
	v.y = +DrivenSpeed.x * DriverForce.z + DrivenSpeed.y * DriverForce.z * DriverForce.z * MAGNETICAL_HOLD;
