...
void CPhysics::AddDefault(DefaultSphere* lpDefaultSphere) {
	lpDefaultSphere->tempType = TYPE_DEFAULT_SPHERE;
	ListDefaultSphere.push_back(lpDefaultSphere);
	CountDefaultSphere++;
}

void CPhysics::AddElectricalField() {
...
void CPhysics::AddMagneticalField() {
